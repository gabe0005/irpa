    ...
    <div id="modal-vf" class="modal modal-preg">
        <div class="flex center">
            <div class="modal-container">
                <div class="modal-header flex v-center">
                    <h2>Nueva pregunta de Verdadero y Falso</h2>
                </div>
                <div class="modal-body">
                    <div class="modal-options">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="title">
                                <h3>Definir pregunta como verdadera o falsa</h3>
                            </div>
                            <div class="detalle-vf flex center">
                                <div class="switch">
                                    <label>
